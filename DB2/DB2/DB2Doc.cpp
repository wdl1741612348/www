...
// 缩略图的支持
void CDB2Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CDB2Doc::InitializeSearchContent()
{
...
void CDB2Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
